    ...
    if (loggedIn) {
      return (
        <div className="pb-4">
          ...
          <p className="text-lg font-light text-[#9A7532]">
            {fullName ?? ''}
          </p>
        </div>
      )
      ...
      <div className="pb-4 flex items-center gap-4">
          ...
          <Link href="/profile/chat" className="relative" aria-label="Messages">
            ...
            {unreadChatCount > 0 && (
              <span
                ...
                style={{ backgroundColor: '#DBA69D', color: '#F8F0ED', minWidth: '16px', height: '16px', padding: '0 3px' }}
              >
        ...
        {loggedIn ? (
          <button
            ...
            className="text-[10px] tracking-wide uppercase text-[#9A7532] underline underline-offset-2 decoration-[#9A7532]/40"
          >
            Sign Out
          </button>
        ) : (
